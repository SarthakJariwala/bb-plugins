...
In this page you install the plugin, pick which providers and models pstack uses, and run your first task. Setup is one command plus a short conversation.
