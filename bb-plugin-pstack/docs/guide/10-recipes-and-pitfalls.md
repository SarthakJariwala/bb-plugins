...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards reading /how, /tdd, and automation above the counter.](./images/recipes.jpg)
...
- **Working a delegated scope before children finish.** Spawn is asynchronous, but scope ownership is not. Coordinate children or work elsewhere until BB's child-completion messages cover every required child.
